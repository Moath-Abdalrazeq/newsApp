...
//       </View>
//       // <View style={styles.container}>
//       //     {userID && userName && liveID && ( // Check if necessary properties are available
//       //         <ZegoUIKitPrebuiltLiveStreaming
//       //             ref={prebuiltRef}
//       //             appID={KeyCenter?.appID} // Apply null check here
//       //             appSign={KeyCenter?.appSign} // Apply null check here
//       //             userID={userID}
//       //             userName={userName}
//       //             liveID={liveID}
//       //             config={{
...
//       //                     props.navigation.navigate('LiveStreram');
//       //                 },
//       //                 onWindowMaximized: () => {
